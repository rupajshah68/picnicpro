...
public class PicnicplayActivity extends Activity{
			...
			public void onClick(View v) {
				...
				if(str.endsWith("Turn"))
				{
					...
					else if(ps1==6||ps1==20||ps1==43||ps1==55||ps1==87||ps1==106||ps1==122||ps1==131||ps1==134)
					{
						...
						{
						case 1:
							AlertDialog alertDialog = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 2:
							AlertDialog alertDialog2 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 3:
							AlertDialog alertDialog3 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 4:
							AlertDialog alertDialog4 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 5:
							final AlertDialog alertDialog5 = new AlertDialog.Builder(PicnicplayActivity.this).create();
	    				    ...
	    				    alertDialog5.setButton("Roll", new DialogInterface.OnClickListener() {
	    			            public void onClick(DialogInterface dialog,int which) {
	    			            	...
	    			            	final AlertDialog dice=new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 6:
							AlertDialog alertDialog6 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 7:
							AlertDialog alertDialog7 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 8:
							AlertDialog alertDialog8 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 9:
							AlertDialog alertDialog9 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 10:
							AlertDialog alertDialog10 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						case 11:
							AlertDialog alertDialog11 = new AlertDialog.Builder(PicnicplayActivity.this).create();
							...
							break;
						default:
							AlertDialog alertDialog12 = new AlertDialog.Builder(PicnicplayActivity.this).create();
					...
					{
						final Dialog dia= new Dialog(PicnicplayActivity.this);
						...
						bd.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								...
								{
									no1.setText("2");
									final Dialog dia1= new Dialog(PicnicplayActivity.this);
										...
										public void onClick(View v) {
											...
											else if(rb1.getText().toString().contains("5"))
											{
											 ...
											 Random r=new Random();
							                    ...
							                    {
							                    	AlertDialog over=new AlertDialog.Builder(PicnicplayActivity.this).create();
								...
								{
									no1.setText("3");
									final Dialog dia2= new Dialog(PicnicplayActivity.this);
								...
								{
									no1.setText("4");
									final Dialog dia3= new Dialog(PicnicplayActivity.this);
								...
								{
									no1.setText("5");
									final Dialog dia4= new Dialog(PicnicplayActivity.this);
					...
					if(ps2!=138 && ((ps1!=6 && ps1!=20 && ps1!=43 && ps1!=55 && ps1!=87 && ps1!=106 && ps1!=122 && ps1!=131 && ps1!=134) || (dv!=5)) && ps1!=58 && ps1!=60 && ps1!=62 && ((ps2!=119)||jv==1) && ((ps2!=129)||jv==1))
					{
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString());
						final AlertDialog dice=new AlertDialog.Builder(PicnicplayActivity.this).create();
					...
					else if(!(((ps1!=6 && ps1!=20 && ps1!=43 && ps1!=55 && ps1!=87 && ps1!=106 && ps1!=122 && ps1!=131 && ps1!=134) || (dv!=5)) && ps1!=58 && ps1!=60 && ps1!=62))
					{
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString());
						final AlertDialog dice=new AlertDialog.Builder(PicnicplayActivity.this).create();
					...
					else if (((ps1!=119)||iv==1) && ((ps1!=129)||iv==1) && ps1!=138)
					{
						jv=1;
						j.setText(jv+"");
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
				...
				else
				{
					...
					if(ps1!=138 &&((ps2!=6 && ps2!=20 && ps2!=43 && ps2!=55 && ps2!=87 && ps2!=106 && ps2!=122 && ps2!=131 && ps2!=134)||dv2!=5) &&  ps2!=58 && ps2!=60 && ps2!=62 && ((ps1!=119)||iv==1) &&(ps1!=129||iv==1))
					{
					bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
					bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString());
					final AlertDialog dice=new AlertDialog.Builder(PicnicplayActivity.this).create();
					...
					else if(!((ps2!=6 && ps2!=20 && ps2!=43 && ps2!=55 && ps2!=87 && ps2!=106 && ps2!=122 && ps2!=131 && ps2!=134)||dv2!=5 && ps2!=58 && ps2!=60 && ps2!=62))
					{
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString());
						final AlertDialog dice=new AlertDialog.Builder(PicnicplayActivity.this).create();
					...
					else if (((ps2!=119)||jv==1) && ((ps2!=129)||jv==1) && ps2!=138)
					{
						iv=1;
						i.setText(iv+"");
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
