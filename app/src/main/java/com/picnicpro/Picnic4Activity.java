...
public class Picnic4Activity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i1=new Intent(getApplicationContext(),Picnicplay4Activity.class);
				i1.putExtra("Name1","Player 1");
				i1.putExtra("Name2","Player 2");
				i1.putExtra("Name3","Player 3");
				i1.putExtra("Name4","Player 4");
				...
				RadioGroup r4 = (RadioGroup) findViewById(R.id.radioGroup4);
				int id4=r4.getCheckedRadioButtonId();
				RadioButton rb4=(RadioButton)findViewById(id4);
				if(rb4!=null)
				{
					i1.putExtra("Radio4", rb4.getText().toString());
				}
				...
				if(rb1!=null && rb2!=null && rb3!=null && rb4!=null && rb1.getText().toString()!=rb2.getText().toString() && rb2.getText().toString()!=rb3.getText().toString() && rb1.getText().toString()!=rb3.getText().toString() && rb1.getText().toString()!=rb4.getText().toString() && rb2.getText().toString()!=rb4.getText().toString() && rb3.getText().toString()!=rb4.getText().toString())
				{
				startActivity(i1);
				}
				else
				{
					Toast.makeText(getApplicationContext(),"Please select all the values. Also make sure the color of markers for Player 1, Player 2, Player 3 and Player 4 are different.", Toast.LENGTH_LONG).show();
				}
			}
		});
    }
