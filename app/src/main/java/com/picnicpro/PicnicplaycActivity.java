...
public class PicnicplaycActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer m=MediaPlayer.create(getApplicationContext(), R.raw.diceroll);
        final String pc1;
        final String pc2;
        ...
        dice.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(str.endsWith("Turn"))
				{
					...
					{
						if(ps2!=138 && ((ps2!=119)||jv==1) && ((ps2!=129)||jv==1))
						{
							bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
							bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString());
						}
					...
					else if(ps1==6||ps1==20||ps1==43||ps1==55||ps1==87||ps1==106||ps1==122||ps1==131||ps1==134)
					{
						...
						{
						case 1:
							AlertDialog alertDialog = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 2:
							AlertDialog alertDialog2 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 3:
							AlertDialog alertDialog3 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 4:
							AlertDialog alertDialog4 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 5:
							final AlertDialog alertDialog5 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
	    				    ...
	    				    alertDialog5.setButton("Roll", new DialogInterface.OnClickListener() {
	    			            public void onClick(DialogInterface dialog,int which) {
	    			            	...
	    			            	final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
	    	        				dice.setTitle("After rolling, number on the dice:"+dr);
	    	        				dice.setMessage("Balance of "+Name1+":Rs. "+pb1.getText().toString()+"\n"+"Balance of "+Name2+":Rs. "+pb2.getText().toString());
	    	        				 dice.setButton("OK", new DialogInterface.OnClickListener() {
	    	     			            public void onClick(DialogInterface dialog,int which) {
	    	     			            	dice.cancel();
	    	     			            	Button b=(Button)findViewById(R.id.dice);
	    	     			            	b.performClick();
	    	     			            }
	    	     			        });
	    	        				dice.setCancelable(false);
	    	        				dice.show();
	    			            	}
	    			        });
	    				    alertDialog5.show();
							break;
						case 6:
							AlertDialog alertDialog6 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 7:
							AlertDialog alertDialog7 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 8:
							AlertDialog alertDialog8 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 9:
							AlertDialog alertDialog9 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 10:
							AlertDialog alertDialog10 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						case 11:
							AlertDialog alertDialog11 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
							...
							break;
						default:
							AlertDialog alertDialog12 = new AlertDialog.Builder(PicnicplaycActivity.this).create();
					...
					{
						final Dialog dia= new Dialog(PicnicplaycActivity.this);
						...
						bd.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								...
								{
									no1.setText("2");
									final Dialog dia1= new Dialog(PicnicplaycActivity.this);
										...
										public void onClick(View v) {
											...
											else if(rb1.getText().toString().contains("5"))
											{
											 ...
											 Random r=new Random();
							                    ...
							                    {
                                                    pb1.setText("OUT");
							                    	AlertDialog over=new AlertDialog.Builder(PicnicplaycActivity.this).create();
							        				over.setTitle("Game Over.");
							        				over.setMessage(Name1+" could not pay the required amount and so the player has gone out of the game. "+Name2+" wins the game.");
								...
								{
									no1.setText("3");
									final Dialog dia2= new Dialog(PicnicplaycActivity.this);
								...
								{
									no1.setText("4");
									final Dialog dia3= new Dialog(PicnicplaycActivity.this);
								...
								{
									no1.setText("5");
									final Dialog dia4= new Dialog(PicnicplaycActivity.this);
					...
					else
                    {
                    	...
                    	AlertDialog over=new AlertDialog.Builder(PicnicplaycActivity.this).create();
        				over.setTitle("Game Over.");
        				over.setMessage(Name2+" could not pay the required amount and so computer has gone out of the game. "+Name1+" wins the game.");
        				 over.setButton("OK", new DialogInterface.OnClickListener() {
     			            public void onClick(DialogInterface dialog,int which) {
     			            	Intent i1=new Intent(getApplicationContext(),PicnicActivity.class);
     							startActivity(i1);
					...
					if(ps2!=138 && pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT" && ((ps1!=6 && ps1!=20 && ps1!=43 && ps1!=55 && ps1!=87 && ps1!=106 && ps1!=122 && ps1!=131 && ps1!=134) || (dv!=5)) && ps1!=58 && ps1!=60 && ps1!=62 && ((ps2!=119)||jv==1) && ((ps2!=129)||jv==1))
					{
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString());
						final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
        				...
        				dice.setMessage("Balance of "+Name1+":Rs. "+pb1.getText().toString()+"\n"+"Balance of "+Name2+":Rs. "+pb2.getText().toString());
        				 dice.setButton("OK", new DialogInterface.OnClickListener() {
     			            public void onClick(DialogInterface dialog,int which) {
     			            	dice.cancel();
                                if(pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT") {
                                    Button b = (Button) findViewById(R.id.dice);
                                    b.performClick();
                                }
     			            }
					...
					else if(pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT" && !(((ps1!=6 && ps1!=20 && ps1!=43 && ps1!=55 && ps1!=87 && ps1!=106 && ps1!=122 && ps1!=131 && ps1!=134) || (dv!=5)) && ps1!=58 && ps1!=60 && ps1!=62))
					{
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString());
						final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
					...
					else if (((ps1!=119)||iv==1) && ((ps1!=129)||iv==1) && ps2!=138 && pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT")
					{
						jv=1;
						j.setText(jv+"");
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
					...
					else if (ps2==138 && pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT")
					{
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString());
						final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
					...
					else if(ps1==138 && pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT")
					{
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString());
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
						final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
				...
				else
				{
					...
					{
						if(ps1!=138 && ((ps1!=119)||iv==1) &&(ps1!=129||iv==1))
						{
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString());
						}
					...
					else if(ps2==6||ps2==20||ps2==43||ps2==55||ps2==87||ps2==106||ps2==122||ps2==131||ps2==134)
					{
						...
						case 5:
	    				    ...
	    				    alertDialog5.setMessage("Roll the dice and earn 50 times money of the given number");
	    				    alertDialog5.setCancelable(false);
	    				    alertDialog5.setButton("OK", new DialogInterface.OnClickListener() {
	    			            public void onClick(DialogInterface dialog,int which) {
	    			            	Random r=new Random();
	    			            	int dr=r.nextInt(6)+1;
	    			            	if(so==true)
	    							...
	    							bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString());
	    							final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
	    	        				dice.setTitle("Dice Thrown:"+dr);
	    	        				dice.setMessage("Balance of "+Name2+":Rs. "+pb2.getText().toString()+"\n"+"Balance of "+Name1+":Rs. "+pb1.getText().toString());
	    	        				 dice.setButton("OK", new DialogInterface.OnClickListener() {
	    	     			            public void onClick(DialogInterface dialog,int which) {
	    	     			            	dice.cancel();
	    	     			            }
					...
					else if(ps2==58||ps2==60||ps2==62)
					{
						...
						short g1;
						g1=(short) (ro.nextInt(4)+2);
						short g2=(short)(ro.nextInt(4)+1);;
						while(g2==g1)
						{
						g2=(short)(ro.nextInt(4)+1);
						}
						short g=(short)(ro.nextInt(6)+1);
						if(so==true)
						{
							m.start();
						}
						...
						{
							pba2+=100;
							Toast.makeText(getApplicationContext(), "The numbers chosen by computer are "+g1+" and "+g2+". The number thrown is "+g+". So computer wins Rs. 100.", Toast.LENGTH_LONG).show();
						}
						else
						{
							pba2-=100;
							Toast.makeText(getApplicationContext(), "The numbers chosen by computer are "+g1+" and "+g2+". The number thrown is "+g+". So computer loses Rs. 100.", Toast.LENGTH_LONG).show();
						}
						final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
        				dice.setTitle("Dice Thrown:"+g);
        				dice.setMessage("Balance of "+Name2+":Rs. "+pb2.getText().toString()+"\n"+"Balance of "+Name1+":Rs. "+pb1.getText().toString());
        				 dice.setButton("OK", new DialogInterface.OnClickListener() {
     			            public void onClick(DialogInterface dialog,int which) {
     			            	dice.cancel();
					...
					else
                    {
                    	...
                    	AlertDialog over=new AlertDialog.Builder(PicnicplaycActivity.this).create();
        				over.setTitle("Game Over.");
        				over.setMessage(Name2+" could not pay the required amount and so the player has gone out of the game. "+Name1+" wins the game.");
        				 over.setButton("OK", new DialogInterface.OnClickListener() {
     			            public void onClick(DialogInterface dialog,int which) {
     			            	Intent i1=new Intent(getApplicationContext(),PicnicActivity.class);
     							startActivity(i1);
					...
					else if(ps2==52)
					{
						if(d==2)
						{
							...
							{
							TextView t2=(TextView)r1.getChildAt(ps2);
							t2.setBackgroundDrawable(getResources().getDrawable(R.drawable.textview));
							}
							else if(ps1==ps2)
							{
								TextView t=(TextView)r1.getChildAt(ps2);
					...
					if(pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT" && ps1!=138 &&((ps2!=6 && ps2!=20 && ps2!=43 && ps2!=55 && ps2!=87 && ps2!=106 && ps2!=122 && ps2!=131 && ps2!=134)||dv2!=5) && ((ps1!=119)||iv==1) &&(ps1!=129||iv==1))
					{
					bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString()+"\n Turn");
					bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString());
					final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
					...
					else if(pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT" && !((ps2!=6 && ps2!=20 && ps2!=43 && ps2!=55 && ps2!=87 && ps2!=106 && ps2!=122 && ps2!=131 && ps2!=134)||dv2!=5))
					{
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
						bo.setText("Balance of\n"+Name1+": \n Rs."+pb1.getText().toString());final AlertDialog dice=new AlertDialog.Builder(PicnicplaycActivity.this).create();
	    				dice.setTitle("Dice Thrown:"+d);
	    				dice.setMessage("Balance of "+Name2+":Rs. "+pb2.getText().toString()+"\n"+"Balance of "+Name1+":Rs. "+pb1.getText().toString());
	    				 dice.setButton("OK", new DialogInterface.OnClickListener() {
	 			            public void onClick(DialogInterface dialog,int which) {
					...
					else if (pb1.getText().toString()!="OUT" && pb2.getText().toString()!="OUT" && ((ps2!=119)||jv==1) && ((ps2!=129)||jv==1) && ps1!=138)
					{
						iv=1;
						i.setText(iv+"");
						bo2.setText("Balance of\n"+Name2+": \n Rs."+pb2.getText().toString()+"\n Turn");
				...
				{
					over.setMessage("1st Position:"+Name1+" Balance:Rs. "+pb1.getText().toString()+"\n 2nd Position:"+Name2+" Balance:Rs. "+pb2.getText().toString());
				}
				else if(Integer.parseInt(pb1.getText().toString())<Integer.parseInt(pb2.getText().toString()))
				{
					over.setMessage("1st Position:"+Name2+" Balance:Rs. "+pb2.getText().toString()+"\n 2nd Position:"+Name1+" Balance:Rs. "+pb1.getText().toString());
				}
				else
				{
					over.setMessage("1st Position:"+"\n"+Name1+"\n"+Name2+"\n Balance Rs. "+pb1.getText().toString());
				}
				over.setButton("OK", new DialogInterface.OnClickListener() {
		            public void onClick(DialogInterface dialog,int which) {
		            	Intent i1=new Intent(getApplicationContext(),PicnicActivity.class);
